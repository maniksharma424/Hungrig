...
export const SERVICES_IMG_CLASSNAME = "img-1 sm:w-[270px] sm:h-[333px] w-[100px] h-[180px] sm:flex sm:flex-col sm:items-center sm:justify-centre flex flex-col items-centre justify-centre"
