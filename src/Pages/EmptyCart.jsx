...
const EmptyCart = () => {
  return (
    <div className='empty-cart w-full  h-[700px] bg-white flex flex-col justify-center items-center'>
        <img className=' bg-center bg-contain bg-no-repeat w-[270px] h-[276px]' src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/2xempty_cart_yfxml0" alt="Empty Cart" srcset="" />
