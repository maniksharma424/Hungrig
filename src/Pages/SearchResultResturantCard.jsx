    ...
    return (
      <div className="Search-Result-Dish-Card">
        <div className="Search-Result-Dish-Info">
          ...
          <p>
            <span>{Dish?.card?.card?.restaurant?.info?.avgRating}</span>{" "}
            <span>
        ...
        <div className="Search-Result-Dish-Add-Cart">
          <div
            className="Search-Result-Dish-Image"
            style={{
              backgroundImage: `url(https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/${Dish?.card?.card?.info?.imageId})`,
              height: "150px",
              width: "150px",
            }}
          ></div>
        ...
        <div className="Search-Result-Restaurant-Card">
          ...
          <div className="Search-Result-Restaurant-info">
            ...
            <p>
              ...
              <span>{Restaurant?.card?.card?.info?.sla?.deliveryTime}</span>
              <span>{Restaurant?.card?.card?.info?.costForTwoMessage}</span>
            </p>
            <p>
