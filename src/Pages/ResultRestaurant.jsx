...
const ResultRestaurant = ({ Restaurant }) => {
  return (
    <div className="Search-Result-Restaurant? pl-2 rounded-md my-9 mb-24 flex flex-wrap justify-start items-center relative right-[115px]  p-1 bg-white w-[385px] h-fit border-[1px] ">
